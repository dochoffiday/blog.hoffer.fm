    ...
    if (!($.SyntaxHighlighter || false)) {
        $.SyntaxHighlighter = {
            ...
            'config': {
				 ...
				 */
                'prettifyBaseUrl': false ? 'http://192.168.1.2/repos/jquery-syntaxhighlighter/prettify' : 'https://balupton.github.com/jquery-syntaxhighlighter/prettify',

				/**
				 * The baseUrl to load our Syntax Highlighter from.
				 * This is used to load in the stylesheet and additional themes.
				 */
                'baseUrl': false ? 'http://192.168.1.2/repos/jquery-syntaxhighlighter' : 'https://balupton.github.com/jquery-syntaxhighlighter'
            },
